  ...
  return (
    <section className="section-padding pb-24 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="flex flex-col items-center gap-8 max-w-md mx-auto">
          ...
          <a href={SOUNDCLOUD_LIBRARY} target="_blank" rel="noopener noreferrer" className="glass-button text-sm md:text-base group inline-flex items-center gap-2 mb-8">
