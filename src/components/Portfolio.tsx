        ...
        >
          {articles.map((article, i) => (
            <motion.div key={i} variants={fadeUpItem} className="h-full">
              <TiltCard className="glass-card h-full min-h-0 lg:min-h-[360px] xl:min-h-[380px] p-5 lg:p-7 cursor-pointer group relative overflow-hidden flex flex-col" style={{ WebkitTransform: 'translateZ(0)', transform: 'translateZ(0)' }}>
                <motion.div
